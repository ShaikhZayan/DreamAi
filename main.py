...
st.sidebar.info("This AI helps you interprets and understand your dreams by generating symbolized descriptions.")
with st.form(key="dream_form"):
    user_dream = st.text_area("Enter Your Dream", height=100)
    analyze_button = st.form_submit_button("Analyze Dream", help="Click to interprets your dream")
    if analyze_button:
        min_words = 5
        min_chars = 20
